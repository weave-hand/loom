...
- [ ] **Iceberg inline read rebuilds Parquet every query** `{#iss-iceberg-inline-reparse area:iceberg status:open from:2026-06-18-iceberg-landing-backend-design pr:#90 spec:2026-06-22-iceberg-inline-memtable-serving-design}`
