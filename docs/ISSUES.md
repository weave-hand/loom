...
- [ ] **Flush idempotency under at-least-once redelivery is unasserted** `{#iss-flush-at-least-once-idempotency area:iceberg status:open from:engine-wire-flush-vertical pr:#108 spec:2026-06-22-flush-idempotency-test-design}`
