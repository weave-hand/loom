...
- [x] **Serving faults not logged server-side** `{#iss-serving-faults-not-logged area:query status:fixed from:tracing-pass pr:- spec:2026-06-21-serving-fault-logging-design}`
